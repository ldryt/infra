{ config, pkgs, lib, vars, ... }: {
  ...
  systemd.services.init-ocis-network = {
    description =
      "Create the network named ${vars.services.ocis.podmanNetwork}.";
  ...
  virtualisation.oci-containers.containers = {
    "ocis" = {
      ...
      environment = {
        ...
        OCIS_OIDC_ISSUER =
          "https://${vars.services.authelia.subdomain}.${vars.zone}";
  ...
  services.caddy.virtualHosts."${vars.services.ocis.subdomain + "."
    ...
    clients = [
      {
        ...
        redirect_uris = [
          ...
          "https://${
            vars.services.ocis.subdomain + "." + vars.zone
          }/oidc-callback.html"
          "https://${
            vars.services.ocis.subdomain + "." + vars.zone
  ...
  services.restic.backups.ocis = {
    ...
    initialize = true;
    passwordFile =
      config.sops.secrets."backups/restic/ocis/repositoryPass".path;
    pruneOpts = [
      "--keep-daily 7"
      "--keep-weekly 8"
      "--keep-monthly 12"
